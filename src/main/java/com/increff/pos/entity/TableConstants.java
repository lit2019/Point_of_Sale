...
public class TableConstants {
    ...
    public static final String POS_SEQ_TABLE_NAME = "pos_sequences";
    public static final String POS_BRAND_SEQ = "pos_brand_seq";
    public static final String POS_PRODUCT_SEQ = "pos_product_seq";
